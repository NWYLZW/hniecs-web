...
(function () {
  ...
  var $funcType = function (params, results, variadic) {
    var typeKey = $mapArray(params, function (p) {
      return p.id;
    }).join(",") + "$" + $mapArray(results, function (r) {
      return r.id;
    }).join(",") + "$" + variadic;
    ...
    if (typ === undefined) {
      ...
      if (results.length === 1) {
        ...
        string += " (" + $mapArray(results, function (r) {
          return r.string;
        }).join(", ") + ")";
      }
  ...
  var $internalize = function (v, t, recv) {
    ...
    switch (t.kind) {
      ...
      case $kindSlice:
        return new t($mapArray(v, function (e) {
          return $internalize(e, t.elem);
        }));
      case $kindString:
        v = String(v);
  ...
  $packages["github.com/gopherjs/gopherjs/js"] = (function () {
    ...
    }, { prop: "Set", name: "Set", pkg: "", typ: $funcType([$String, $emptyInterface], [], false) }, {
      prop: "Delete",
      name: "Delete",
      pkg: "",
      typ: $funcType([$String], [], false)
    }, { prop: "Length", name: "Length", pkg: "", typ: $funcType([], [$Int], false) }, {
      prop: "Index",
      name: "Index",
      pkg: "",
    ...
    }, { prop: "Call", name: "Call", pkg: "", typ: $funcType([$String, sliceType], [ptrType], true) }, {
      prop: "Invoke",
      name: "Invoke",
      pkg: "",
      typ: $funcType([sliceType], [ptrType], true)
    }, { prop: "New", name: "New", pkg: "", typ: $funcType([sliceType], [ptrType], true) }, {
      prop: "Bool",
      name: "Bool",
      pkg: "",
    ...
    ptrType$1.methods = [{
      ...
      pkg: "",
      typ: $funcType([], [$String], false)
    }, { prop: "Stack", name: "Stack", pkg: "", typ: $funcType([], [$String], false) }];
  ...
  $packages["runtime"] = (function () {
    ...
    TypeAssertionError.init("runtime", [{
      ...
      typ: $String,
      tag: ""
    }, { prop: "missingMethod", name: "missingMethod", anonymous: false, exported: false, typ: $String, tag: "" }]);
    $init = function () {
      $pkg.$init = function () {
      };
      /* */
  ...
  $packages["main"] = (function () {
    var $pkg = {}, $init, js, Duration, DigitalRain, waterDrop, GlyphCanvas, ptrType, sliceType, sliceType$1, funcType,
      ptrType$1, sliceType$2, ptrType$2, ptrType$3, funcType$1, sliceType$3, mapType, mapType$1, overlap,
      githubLinkColor, githubLinkOverColor, githubLink, level1Cols, level2Cols, lowGlyphCanvases, highGlyphCanvases,
      backgrounds, index, main, itoa, ftoa, randi, NewDigitalRain, shortLink, NewGlyphCanvas;
    js = $packages["github.com/gopherjs/gopherjs/js"];
        ...
        s: while (true) {
          switch ($s) {
            ...
            case 2:
              ...
              // 降低层级
              cover.style['z-index'] = $externalize("-1", $String);
    ...
    DigitalRain.ptr.prototype.layout = function () {
      ...
      // 降低层级
      r.canvas.style['z-index'] = $externalize("-1", $String);
      ...
      r.canvas.addEventListener($externalize("click", $String), $externalize((function $b (ev) {
        ...
        s: while (true) {
          switch ($s) {
            ...
            case 2:
              /* */
              if (!(r.Clicked === $throwNilPointerError)) {
                $s = 4;
                continue;
              }
              /* */
    ...
    DigitalRain.prototype.layout = function () {
    ...
    DigitalRain.prototype.overLink = function (x, y) {
      return this.$val.overLink(x, y);
    };
    ...
    DigitalRain.prototype.dropWaterAtCol = function (col, speed, length, start, created) {
      return this.$val.dropWaterAtCol(col, speed, length, start, created);
    };
    ...
    DigitalRain.prototype.dropRandomWaterDrop = function (timestamp) {
      return this.$val.dropRandomWaterDrop(timestamp);
    };
    ...
    DigitalRain.prototype.maxRows = function () {
      return this.$val.maxRows();
    };
    ...
    DigitalRain.prototype.drawGlyphAt = function (nidx, col, row, brightness, head) {
      return this.$val.drawGlyphAt(nidx, col, row, brightness, head);
    };
    ...
    DigitalRain.prototype.drawGlyphElAt = function (glyphCanvas, nidx, col, row, brightness) {
      return this.$val.drawGlyphElAt(glyphCanvas, nidx, col, row, brightness);
    };
    ...
    DigitalRain.prototype.drawTitle = function (text, color, fontSize, y) {
      return this.$val.drawTitle(text, color, fontSize, y);
    };
    ...
    DigitalRain.prototype.drawTitles = function () {
      return this.$val.drawTitles();
    };
    DigitalRain.ptr.prototype.loop = function (timestamp) {
      var _i, _r, _r$1, _r$2, _r$3, _ref, age, brightness, drop, drops, elapsed, gbrightness, gcount, gl, glyph, i, r,
        ri, ri$1, row, timestamp, x, x$1, $deferred;
      /* */
      var $err = null;
      try {
        $deferred = [];
    ...
    DigitalRain.prototype.loop = function (timestamp) {
      return this.$val.loop(timestamp);
    };
    ...
    GlyphCanvas.ptr.prototype.Glyph = function (gx, gy) {
      ...
      if (mx === false) {
        mx = {};
        _key = gx;
        (gc.glyphs || $throwRuntimeError("assignment to entry in nil map"))[$Int.keyFor(_key)] = { k: _key, v: mx };
      }
      ...
      if (my === null) {
        ...
        // 降低层级
        my.style['z-index'] = $externalize("-1", $String);
        my.width = 100;
        my.height = 100;
        ctx = my.getContext($externalize("2d", $String));
        ctx.drawImage(gc.jso, gx, gy, 100, 100, 0, 0, 100, 100);
        _key$1 = gy;
        (mx || $throwRuntimeError("assignment to entry in nil map"))[$Int.keyFor(_key$1)] = { k: _key$1, v: my };
      }
      return my;
    };
    GlyphCanvas.prototype.Glyph = function (gx, gy) {
      return this.$val.Glyph(gx, gy);
    };
    ptrType$2.methods = [{
      prop: "start",
      name: "start",
    ...
    }, { prop: "layout", name: "layout", pkg: "main", typ: $funcType([], [], false) }, {
      prop: "overLink",
      name: "overLink",
      pkg: "main",
      ...
      name: "dropWaterAtCol",
      pkg: "main",
      typ: $funcType([$Int, $Float64, $Int, $Float64, Duration], [], false)
    }, {
      prop: "dropRandomWaterDrop",
      name: "dropRandomWaterDrop",
      pkg: "main",
      typ: $funcType([Duration], [], false)
    }, { prop: "maxRows", name: "maxRows", pkg: "main", typ: $funcType([], [$Int], false) }, {
      prop: "drawGlyphAt",
      name: "drawGlyphAt",
      pkg: "main",
      typ: $funcType([$Int, $Int, $Float64, $Float64, $Bool], [], false)
    }, {
      prop: "drawGlyphElAt",
      name: "drawGlyphElAt",
      pkg: "main",
      typ: $funcType([ptrType, $Int, $Int, $Float64, $Float64], [], false)
    }, {
      prop: "drawTitle",
      name: "drawTitle",
      pkg: "main",
      typ: $funcType([$String, $String, $Float64, $Float64], [$Float64], false)
    }, { prop: "drawTitles", name: "drawTitles", pkg: "main", typ: $funcType([], [], false) }, {
      prop: "loop",
      name: "loop",
      pkg: "main",
      typ: $funcType([Duration], [], false)
    ...
    DigitalRain.init("main", [{
      ...
      typ: ptrType$3,
      tag: ""
    }, { prop: "canvas", name: "canvas", anonymous: false, exported: false, typ: ptrType$3, tag: "" }, {
      prop: "ctx",
      name: "ctx",
      anonymous: false,
      exported: false,
      typ: ptrType$3,
      tag: ""
    }, { prop: "width", name: "width", anonymous: false, exported: false, typ: $Float64, tag: "" }, {
      prop: "height",
      name: "height",
      anonymous: false,
      exported: false,
      typ: $Float64,
      tag: ""
    }, { prop: "ratio", name: "ratio", anonymous: false, exported: false, typ: $Float64, tag: "" }, {
      prop: "timestamp",
      name: "timestamp",
      anonymous: false,
      exported: false,
      ...
      prop: "highGlyphCanvas",
      name: "highGlyphCanvas",
      anonymous: false,
      exported: false,
      typ: ptrType,
      tag: ""
      ...
      typ: $Float64,
      tag: ""
    }, { prop: "Clicked", name: "Clicked", anonymous: false, exported: true, typ: funcType, tag: "" }]);
    waterDrop.init("main", [{
      prop: "col",
      name: "col",
      anonymous: false,
      ...
      typ: $Int,
      tag: ""
    }, { prop: "row", name: "row", anonymous: false, exported: false, typ: $Float64, tag: "" }, {
      prop: "start",
      name: "start",
      anonymous: false,
      exported: false,
      typ: $Float64,
      tag: ""
    }, { prop: "speed", name: "speed", anonymous: false, exported: false, typ: $Float64, tag: "" }, {
      prop: "glyphs",
      name: "glyphs",
      anonymous: false,
      exported: false,
      typ: sliceType$3,
      tag: ""
    }, { prop: "spedup", name: "spedup", anonymous: false, exported: false, typ: $Bool, tag: "" }, {
      prop: "created",
      name: "created",
      anonymous: false,
      exported: false,
    ...
    GlyphCanvas.init("main", [{
      ...
      typ: ptrType$3,
      tag: ""
    }, { prop: "glyphs", name: "glyphs", anonymous: false, exported: false, typ: mapType$1, tag: "" }]);
    $init = function () {
      $pkg.$init = function () {
      };
      /* */
